...
export interface ApiAlertAlert extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::alert.alert'> &
      Schema.Attribute.Private;
    monitor: Schema.Attribute.Relation<'manyToOne', 'api::monitor.monitor'>;
    name: Schema.Attribute.String & Schema.Attribute.Required & Schema.Attribute.Unique;
    notification_channel: Schema.Attribute.JSON & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    rules: Schema.Attribute.JSON & Schema.Attribute.Required;
...
export interface ApiMonitorMonitor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    auth_token: Schema.Attribute.Password & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    endpoint: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::monitor.monitor'> &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required & Schema.Attribute.Unique;
    publishedAt: Schema.Attribute.DateTime;
    server: Schema.Attribute.Relation<'manyToOne', 'api::server.server'>;
    type: Schema.Attribute.Enumeration<['node', 'mysql', 'nginx', 'blackbox']> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
  };
...
export interface ApiPlaybookPlaybook extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ansible_file: Schema.Attribute.String & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::playbook.playbook'> &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required & Schema.Attribute.Unique;
    publishedAt: Schema.Attribute.DateTime;
    type: Schema.Attribute.Enumeration<['lemp', 'site', 'backup', 'monitor']> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
...
export interface ApiServerServer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    hostname: Schema.Attribute.String & Schema.Attribute.Required & Schema.Attribute.Unique;
    ...
    publishedAt: Schema.Attribute.DateTime;
    server_type: Schema.Attribute.Enumeration<['web', 'database', 'monitor']> &
      Schema.Attribute.Required;
    sites: Schema.Attribute.Relation<'oneToMany', 'api::site.site'>;
    ssh_key: Schema.Attribute.Text & Schema.Attribute.Required;
    ssh_port: Schema.Attribute.Integer & Schema.Attribute.Required & Schema.Attribute.DefaultTo<22>;
    status: Schema.Attribute.Enumeration<['active', 'inactive', 'maintenance']> &
      Schema.Attribute.Required &
...
export interface ApiSiteSite extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    backups: Schema.Attribute.Relation<'oneToMany', 'api::backup.backup'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::site.site'> &
      Schema.Attribute.Private;
    nginx_config: Schema.Attribute.JSON & Schema.Attribute.Required;
    php_version: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    server: Schema.Attribute.Relation<'manyToOne', 'api::server.server'>;
    ssl_status: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
